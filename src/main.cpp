...
uint256 hashGenesisBlock("0x9521de4d4af556dae45a6eb2644c12717dcf8959042d887ee839009ed419b41e");
...
const string strMessageMagic = "KimhengCoin Signed Message:\n";
...
{
    int64 nSubsidy = 50 * COIN; //Amt of coins per block
...
static const int64 nTargetTimespan = 1 * 60; // KimhengCoin: 60s
static const int64 nTargetSpacing = 15; // KimhengCoin: 15 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal KimhengCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "KimhengCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	CBlock(hash=14dc23f54de47df79717, PoW=00000aeb1f05fbf0b2fa, ver=1, 			hashPrevBlock=00000000000000000000, hashMerkleRoot=ef7e256a2c, 			nTime=1399574511, nBits=1e0ffff0, nNonce=2086299649, vtx=1)
  	...
  	vMerkleTree: ef7e256a2c */
        ...
        // Genesis block
        const char* pszTimestamp = "KimhengCoin Launch date. Heng Loves Yen.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1518614412;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2086417530;
        ...
        assert(block.hashMerkleRoot == uint256("0x90a8369f6ff070b3c76b5ead34e10c5c2f6c5999df0030f708de00e824a42245"));
